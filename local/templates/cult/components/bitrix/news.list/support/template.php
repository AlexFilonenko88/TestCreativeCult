    ...
    <div class="support-items">
        <?php foreach ($arResult["ITEMS"] as $arItem): ?>
            ...
            $this->AddDeleteAction($arItem['ID'], $arItem['DELETE_LINK'],
                CIBlock::GetArrayByID($arItem["IBLOCK_ID"], "ELEMENT_DELETE"), array("CONFIRM" => GetMessage('CT_BNL_ELEMENT_DELETE_CONFIRM')));
            ?>
            <div class="support-card" data-aos="fade-up" id="<?= $this->GetEditAreaId($arItem['ID']); ?>">
                <a target="_blank" href="<?= $arItem['DISPLAY_PROPERTIES']['FILE']['FILE_VALUE']['SRC'] ?>"
                   download="<?= $arItem['DISPLAY_PROPERTIES']['FILE']['FILE_VALUE']['SRC'] ?>"
