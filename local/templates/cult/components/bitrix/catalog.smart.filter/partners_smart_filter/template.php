...
<?php
//echo "<pre>";
//var_dump($arResult["ITEMS_FILTER"]);
//echo "</pre>";
//?>

<div class="partners small-margin-top container">
    <form name="<? echo $arResult["FILTER_NAME"] . "_form" ?>" action="<? echo $arResult["FORM_ACTION"] ?>"
          method="get" class="smartfilter contacts-form">
        <? foreach ($arResult["HIDDEN"] as $arItem): ?>
            <input type="hidden" name="<? echo $arItem["CONTROL_NAME"] ?>" id="<? echo $arItem["CONTROL_ID"] ?>"
                   value="<? echo $arItem["HTML_VALUE"] ?>"/>
        <? endforeach; ?>
        <div class="contacts-form-selects">
            <div class="select-smartfilter">
                ...
                <div class="select-drop">
                    <ul class="select-list">
                        ...
                        <? foreach ($arResult["ITEMS_FILTER"]["SERVICE"]["VALUES"] as $item): ?>
                            <li class="select-item">
                                <a data-control-name="<?= $item['CONTROL_NAME'] ?>" href="#"
                                   onclick="smartFilter.click(this)"><?= $item["VALUE"] ?></a></li>
                        <? endforeach; ?>
                    </ul>
                </div>
            </div>
            ...
            <div class="select-smartfilter">
                <a href class="select-head">
                    ...
                    <input type="text" name="city" readonly hidden class="select-input city-input">
                </a>
                <div class="select-drop">
                    <ul class="select-list">
                        <li class="select-item"><a href="#">Все города</a></li>
                        <? foreach ($arResult["ITEMS_FILTER"]["CITY"]["VALUES"] as $item): ?>
                            <li class="select-item">
                                <a data-control-name="<?= $item['CONTROL_NAME'] ?>" href="#"
                                   onclick="smartFilter.click(this)"><?= $item["VALUE"] ?></a></li>
                        <? endforeach; ?>
